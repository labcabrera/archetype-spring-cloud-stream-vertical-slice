...
TIP: En el caso de usar un enfoque _Contract-First_ tenemos este mismo ejemplo en el siguiente link:https://github.com/labcabrera/archetype-spring-cloud-stream-vertical-slice-contract-first[repositorio].
